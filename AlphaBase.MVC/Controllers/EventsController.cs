...
using AlphaBase.MVC.Data;
using AlphaBase.MVC.Models;

namespace AlphaBase.MVC.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Details,Date")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Details,Date")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
